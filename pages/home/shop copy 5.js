                                        ...
                                        this.state.goodsList && this.state.goodsList.map((item, index) => {
                                            return (
                                                <TouchableOpacity onPress={() => { navigation.navigate('goodsdetails', { id: item.goods_id }) }} style={[css2.goodsBlock,{width: 165,minWidth:165,maxWidth:165,margin:0,padding:3}]} key={index}>
                                                    {/* <Image style={[css2.goodsImage,{width: 165,height:165,backgroundColor:'pink'}]} source={{ uri: item.goods_image }} /> */}
                                                    <ImageBackground style={[css2.goodsImage,{width: 165,height:165,backgroundColor:'pink'}]} source={{ uri: item.goods_image }}></ImageBackground>
