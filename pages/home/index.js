                    ...
                    >
                        ...
                        <View style={css.maFu}>
                            <View style={common.alignItemsB}>
                                ...
                                <Text style={{ color: '#fff', fontSize: 16, marginLeft: -21 }}>花满佳</Text>
                        ...
                        {this.state.isLoading && this.state.navIndex == 0 ? <Text style={{ textAlign: 'center' }}>加载中，请稍等~</Text> : null}
                        {this.state.isLoading == 0 && this.state.navIndex == 0 ? <Text style={{ textAlign: 'center' }}>暂无数据~</Text> : null}
                    </ScrollView > : null}
