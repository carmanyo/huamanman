...
export default class home extends Component {
  render() {
            ...
            <View style={common.askModal}>
              <View
                ...
                <Text style={{textAlign: 'center'}}>
                  检测到新版本{this.state.currentVersion}，您的版本是
                  {this.state.version}，立即更新！
                </Text>
              </View>
              <View
                style={{
              ...
              <View style={common.askOperation}>
                <TouchableOpacity
                  ...
                  <Text style={[common.confirmBtn, {borderLeftWidth: 0}]}>
                    确认
                  </Text>
                </TouchableOpacity>
              </View>
        ...
        <View style={common.body}>
          ...
          <View style={[common.header]}>
            ...
            <View style={common.headerTitle}>
              <Text style={common.headerTitleText}>扫码</Text>
            </View>
          </View>
    ...
    let modal =
      this.state.ifshowmodal == 1 && this.state.ruleData ? (
        <View
          style={{
            position: 'absolute',
            top: 0,
          ...
          <View
            ...
            <View style={css.jump}>
              <TouchableOpacity
                onPress={() => {
                  this.setState({agree: this.state.agree == 1 ? 0 : 1});
                }}
                style={css.remember}>
                <Image
                  style={this.state.agree == 1 ? css.tick : common.hidden}
                  source={require('../../image/check-3.png')}
                />
                <Image
                  style={this.state.agree == 0 ? css.tick : common.hidden}
                  source={require('../../image/uncheck-3.png')}
                />
            ...
            <TouchableOpacity
              ...
              {this.state.agree == 1 ? (
                <LinearGradient
                  colors={['#F6BF0A', '#F6BF0A']}
                  style={[common.linearBtn, {}]}
                  start={{x: 0, y: 0}}
                  end={{x: 1, y: 1}}>
                  <Text style={common.linearBtnText}>确定</Text>
                </LinearGradient>
              ) : (
                <LinearGradient
                  colors={['#CAC8C6', '#CAC8C6']}
                  style={[common.linearBtn, {}]}
                  start={{x: 0, y: 0}}
                  end={{x: 1, y: 1}}>
                  <Text style={common.linearBtnText}>确定</Text>
        ...
        <View
          ...
          <View
            ...
            <Text
              style={[
                common.askTitle,
                {paddingTop: 22, marginBottom: 20, fontSize: 18},
              ]}>
              用户隐私政策
            </Text>
            <ScrollView style={{maxHeight: height / 2}}>
              <View style={common.alignItemsCenter}>
                <Text style={{fontSize: 15}}>
                  我们非常重视您的用户权益与个人信息的保护，在您使用本APP服务前，请充分阅读并理解
                  <TouchableOpacity
                    onPress={() => {
                      Linking.openURL(
                        'https://hmmshop888.com/index.php?s=/index/app/treaty',
                      );
                    }}>
                    <Text style={{color: '#F3A316'}}>《用户协议》</Text>
                  </TouchableOpacity>
                  和
                  <TouchableOpacity
                    onPress={() => {
                      Linking.openURL(
                        'https://hmmshop888.com/index.php?s=/index/app/policy',
                      );
                    }}>
                    <Text style={{color: '#F3A316'}}>《隐私政策》</Text>
                  </TouchableOpacity>
                  。如果您同意，请点击下面”同意“按钮开始接受我们的服务。
                </Text>
              </View>
            </ScrollView>
            <TouchableOpacity
              ...
              <LinearGradient
                ...
                <Text style={common.linearBtnText}>同意并继续</Text>
              </LinearGradient>
            </TouchableOpacity>
            <TouchableOpacity
              onPress={() => {}}
              ...
              <LinearGradient
                ...
                <Text style={[common.linearBtnText, {color: '#333'}]}>
                  不同意
                </Text>
              </LinearGradient>
            </TouchableOpacity>
      ...
      this.state.ifNotice == true ? (
        <View
          ...
          <View
            ...
            <Text style={[common.askTitle, {fontSize: 16}]}>
              {this.state.newsList[0].title}
            </Text>
            <ScrollView
              style={{
      ...
      <View
          ...
          <ScrollView
            ...
            <View style={css.maFu}>
              <View style={common.alignItemsB}>
                ...
                <Text style={{opacity: 0}}>花满佳</Text>
                <Text style={{color: '#fff', fontSize: 16, marginLeft: -21}}>
                  花满佳
                </Text>
                <TouchableOpacity
                  onPress={() => {
              ...
              <View style={css.funWrap}>
                <TouchableOpacity
                  onPress={() => {
                    this.setState({ifshowmodal: 1});
                  }}
                  style={common.columnCenter}>
                  <Image
                    style={css.funIcon}
                    source={require('../../image/index-1.png')}
                  />
                  <Text style={css.funText}>推广码</Text>
                </TouchableOpacity>
                <TouchableOpacity
                  onPress={() => {
                  ...
                  <Image
                    style={css.funIcon}
                    source={require('../../image/index-2.png')}
                  />
                  <Text style={css.funText}>我的推广</Text>
                </TouchableOpacity>
                <TouchableOpacity
                  onPress={() => {
                  ...
                  <Image
                    style={css.funIcon}
                    source={require('../../image/index-3.png')}
                  />
                  <Text style={css.funText}>余额</Text>
                </TouchableOpacity>
                <TouchableOpacity
                  onPress={() => {
                  ...
                  <Image
                    style={css.funIcon}
                    source={require('../../image/index-4.png')}
                  />
                  <Text style={css.funText}>积分</Text>
                </TouchableOpacity>
              </View>
                      ...
                      return (
                        <View key={index}>
                          {item.image != null ? (
                            <Image
                              style={css.banner}
                              source={{uri: item.image.file_path}}
                            />
                          ) : null}
                        </View>
                      );
              ...
              <View style={css.scrollNotice}>
                <Image
                  style={[css.indexNewsIcon, {marginRight: 10}]}
                  source={require('../../image/notice.png')}
                />
                <MarqueeVertical
                ...
                {this.state.catList.map((item, index) => {
                  return (
                    <TouchableOpacity
                      ...
                      />
                      <Text style={css.catText}>{item.name}</Text>
                    </TouchableOpacity>
                  );
                })}
              </View>

              <View style={css.grayLine} />
                ...
                <View style={[css.goodsWrap, {marginTop: 0}]}>
                  {this.state.goodsList.map((item, index) => {
                    return (
                      <TouchableOpacity
                        onPress={() => {
                          navigation.navigate('goodsdetails', {
                            id: item.goods_id,
                          });
                        }}
                        style={css.goodsBlock}
                        key={index}>
                        {/* <Image style={[css.goodsImage,{resizeMode: 'cover',height:159,width:159}]} source={{ uri: item.goods_image+'?v='+index+1 }} resizeMode='cover' resizeMethod='auto'/> */}
                        {/* <ImageBackground
                                                     style={{height:159,width:159,minHeight:159,minWidth:159}}
                                                     source={{uri: item.goods_image+'?v='+index+1}}
                                                   >
                                                     <Text style={{height:159,width:159,backgroundColor:'rgba(255,255,255,.3)'}}>{index}</Text>
                                                   </ImageBackground> */}
                        {/* <Image onLayout={this.onImageLayout.bind(this)} style={[css.goodsImage, { resizeMode: 'stretch', height: 159, width: 159, }, this.state.style]} source={{ uri: item.goods_image + '?v=' + index + 1 }} resizeMode='stretch' resizeMethod='auto' /> */}
                        {/* {
                                                        item.goods_image?
                                                        <Image style={[css.goodsImage,{width:159,height:159}]} source={{ uri: item.goods_image }} resizeMode='cover' resizeMethod='auto'/>:
                                                        <Image style={[css.goodsImage,{width:159,height:159}]} source={require('../../image/nodata.png')} resizeMode='cover' resizeMethod='auto'/>
                                                    } */}
                        <Image
                          onError={e => {
                          ...
                          onLoadEnd={() => {
                            ...
                            // console.log(this.getImageWidth.bind(this,item.goods_image))
                          }}
                        ...
                        {/* <View style={{flex:1,width:159,height:159}}>
                                                        <Image style={[css.goodsImage,{resizeMode: 'stretch',height:159,width:159,},this.state.style]} source={{ uri: this.state.goodsList[index].goods_image+'?v='+index+1 }} resizeMode='stretch' resizeMethod='auto'/>
                                                    </View> */}
                        {/* <ImageAutoHeight
                        ...
                        <View style={common.alignItemsCenter}>
                          <Text style={css.goodsSku}>
                            立送≈价值{item.rebate}元积分
                          </Text>
                        </View>
                        <View>
                          <View style={common.alignItemsCenter}>
                            ...
                            <Text style={css.bPrice}>
                              {item.goods_sku.goods_price}
                            </Text>
                          </View>
                          {item.goods_sku.goods_coupon != 0 ? (
                            <Text style={css.sPrice}>
                              劵可抵：{item.goods_sku.goods_coupon}元
                            </Text>
                          ) : null}
                        </View>
                        <Image
                ...
                <View style={css.storeWrap}>
                  {this.state.storeList.map((item, index) => {
                    return (
                      <View style={[common.alignItemsCenter, css.store]}>
                        <TouchableOpacity
                          onPress={() => {
                            navigation.navigate('shop', {id: item.merchant_id});
                          }}>
                          <Image
                            style={css.storeLogo}
                            source={{uri: item.logo.file_path}}
                          />
                        </TouchableOpacity>
                        <View style={common.columnStart}>
                          ...
                          <TouchableOpacity
                            ...
                            style={[common.alignItemsCenter, {marginTop: 15}]}>
                            <Image
                              style={css.storeIcon}
                              source={require('../../image/call.png')}
                            />
                            <Text style={{color: '#808080'}}>{item.phone}</Text>
                          </TouchableOpacity>
                          <TouchableOpacity
                            onPress={this.turn2MapApp.bind(
                              this,
                              item.longitude,
                              item.latitude,
                              'gaode',
                            ...
                            style={[common.alignItemsB, {marginTop: 10}]}>
                            {/* <TouchableOpacity style={[common.alignItemsB, { marginTop: 10 }]}> */}
                            <View style={common.alignItemsCenter}>
                              <Image
                                style={css.storeIcon}
                                source={require('../../image/daohang.jpg')}
                              />
                              <Text
                                style={{color: '#808080', width: width / 2}}>
                                {item.province.name}
                                {item.city.name}
                                {item.region.name}
                                {item.address}
                  ...
                  {this.state.storeList.length == 0 ? (
                    <View
                      style={[
                        common.empty,
                        {paddingBottom: 50, marginTop: 30, marginLeft: -10},
                      ]}>
                      <Image
                        style={common.emptyIcon}
                        source={require('../../image/empty2.png')}
                      />
            ...
            {this.state.isLoading && this.state.navIndex == 0 ? (
              <Text style={{textAlign: 'center'}}>加载中，请稍等~</Text>
            ) : null}
            {this.state.isLoading == 0 && this.state.navIndex == 0 ? (
        ...
        <View style={common.navBar}>
          <TouchableOpacity
            ...
            style={common.navBarBlock}>
            <Image
              style={common.navBarIcon}
              source={require('../../image/tabbar-1-s.png')}
            />
          ...
          <TouchableOpacity
            ...
            <Image
              style={common.navBarIcon}
              source={require('../../image/tabbar-2.png')}
            />
          ...
          <TouchableOpacity
            ...
            <Image
              style={common.navBarIcon}
              source={require('../../image/tabbar-3.png')}
            />
          ...
          <TouchableOpacity
            ...
            <Image
              style={common.navBarIcon}
              source={require('../../image/tabbar-4.png')}
            />
  ...
  getCity(longitude, latitude) {
    ...
    // console.log(url)
    fetch(
      `https://restapi.amap.com/v3/assistant/coordinate/convert?locations=${longitude},${latitude}&coordsys=gps&output=json&key=3be5718d299c29e72fced80f03514b90`,
      {method: 'GET'},
    )
      .then(response => response.json())
      .then(jsonDa => {
  ...
  getCityStep2(longitude, latitude) {
    ...
    //访问网络开始
    fetch(
      'http://restapi.amap.com/v3/geocode/regeo?key=3be5718d299c29e72fced80f03514b90&location=' +
        longitude +
        ',' +
        latitude +
      ...
      .then(jsonData => {
        try {
          ...
          that.setState({
            ...
            position:
              jsonData.regeocode.addressComponent.province +
              jsonData.regeocode.addressComponent.city +
              jsonData.regeocode.addressComponent.district,
          });
          setTimeout(() => {
            // Toast.show('刷新成功')
            that.setState({
  ...
  init() {
    ...
    this.getGoodsLists();
    this.getCategorys();
    this.requestCameraPermission2(); //获取摄像头权限
    this.version();
    this.getIndexGetPrices();
    this.getRule();

    // this.requestCameraPermission();//获取位置权限
    // this.getUserDetails();
  }
