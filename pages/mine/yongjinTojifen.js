...
import { getWalletExchangeIntegral, getaddressDel, getCardIndex, getUserDetail, getWalletCash, getExchangeSetting, getWalletExchange } from '../../network/authapi.js'
...
class page extends React.Component {
        ...
        return (
            <View style={common.body}>
                ...
                <View style={[common.header]}>
                    ...
                    <View style={common.headerTitle}><Text style={common.headerTitleText}>佣金兑换积分</Text></View>
                    <TouchableOpacity onPress={() => { navigation.navigate('yongjinTojifenRecord'); }} style={common.headerRight}><Text style={common.headerRightText}>兑换记录</Text></TouchableOpacity>
                </View>
    ...
    getWalletExchangeIntegral(fromData, res => {
        // console.log(res)
            if (res.code == 1) {
                Toast.show('提交成功');
                ...
                setTimeout(() => {
                    ...
                    that.getUserDetails()
                    navigation.navigate('yongjinTojifenRecord')
                }, 1000);
            } else if (res.code == -1) {
                Toast.show(res.msg);
                setTimeout(function () {
