        ...
        return (
            <View style={common.body}>
                ...
                <View style={[common.header]}>
                    ...
                    <View style={common.headerTitle}><Text style={common.headerTitleText}>转入记录</Text></View>
                </View>
                            ...
                            return (
                                <View style={css.recordBlock} key={index}>
                                    <View style={common.alignItemsB}>
                                        <View style={common.alignItemsCenter}><Text style={[common.green, { marginRight: 10 }]}>转入</Text><Text>至余额</Text></View>
                                        <Text>到账数量：{item.total_number}</Text>
                                    </View>
                                    <Text style={css.time}>转入数量：{item.number}</Text>
                                    ...
                                    <Text style={css.time}>转入时间：{item.create_time}</Text>
                                </View>
                            );
                        })}
