      ...
      <View style={common.body}>
        ...
        <View style={[common.header]}>
          ...
          <View style={common.headerTitle}>
            <Text style={common.headerTitleText}>积分</Text>
          </View>
        </View>
        ...
        <View style={[common.main]}>
          {this.state.user ? (
            <ScrollView
              ...
              <Image
                source={require('../../image/jifen.png')}
                style={css.jifen}
              />
              ...
              {this.state.exchangeOpen == 1 ? (
                <TouchableOpacity
                  onPress={() => {
                    navigation.navigate('exchangeBalance');
                  }}
                  style={[
                    css.linearBtn,
                  ...
                  <LinearGradient
                    ...
                    <Text style={common.linearBtnText}>兑换余额</Text>
                  </LinearGradient>
                </TouchableOpacity>
              ) : null}
              <TouchableOpacity
                onPress={() => {
                  navigation.navigate('integralDetail');
                }}>
