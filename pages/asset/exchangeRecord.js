                    ...
                    >
                        ...
                        {this.state.list.map((item, index) => {
                            return (
                                <View style={css.recordBlock}>
                                    ...
                                    <View style={item.status == 5 ? css.typeName : common.hidden}><Text>状态：</Text><Text style={css.yellow}>审核中</Text></View>
                                    <View style={item.status == 10 ? css.typeName : common.hidden}><Text>状态：</Text><Text style={css.green}>提现成功</Text></View>
                                    <View style={item.status == 15 ? css.typeName : common.hidden}><Text>状态：</Text><Text style={css.red}>提现驳回</Text></View>
                                    <View style={css.typeName}><Text>时间：</Text><Text>{item.addtime}</Text></View>
                                    <View style={css.typeName}><Text>地址：</Text><Text>{item.info}</Text></View>
                        ...
                        <View style={css.recordBlock}>
                            <View style={common.alignItemsB}>
                                <View style={common.alignItemsCenter}><Text style={[common.green, { marginRight: 10 }]}>兑换</Text><Text>至余额</Text></View>
                                <Text>￥10000.00</Text>
                            </View>
