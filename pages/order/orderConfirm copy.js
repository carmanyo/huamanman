...
class page extends React.Component {
    ...
    // console.log(detail)
        return (
            <View style={common.body}>
                ...
                {
                    this.state.cardPay == true ?
                        <View style={common.maskCenter}>
                            <View style={common.payModal}>
                                <Text style={common.modalTittle}>请输入以下信息</Text>
                                <TouchableOpacity onPress={()=>{this.setState({cardPay:false})}} style={common.closeWrap}><Image source={require('../../image/close.png')} style={common.close} /></TouchableOpacity>
                                <View style={[common.alignItemsCenter,{marginTop:40,borderBottomWidth:1,borderColor:'rgba(0,0,0,.06)'}]}>
                                    <Text style={[common.need,{textAlign:'left',color:'#333',marginTop:0,marginRight:42}]}>姓名</Text>
                                    <TextInput
                                        onChangeText={(value) => this.setState({ cardName: value })}
                                        value={this.state.cardName} style={[css.textInput, { width: '63%', }]} placeholder='请输入姓名'
                                        autoFocus={true}
                                    />
                                </View>

                                <View style={[common.alignItemsCenter,{marginTop:20,borderBottomWidth:1,borderColor:'rgba(0,0,0,.06)'}]}>
                                    <Text style={[common.need,{textAlign:'left',color:'#333',marginTop:0,marginRight:10}]}>身份证号</Text>
                                    <TextInput
                                        onChangeText={(value) => this.setState({ cardNum: value })}
                                        value={this.state.cardNum} style={[css.textInput, { width: '63%', }]} placeholder='请输入身份证号'
                                        autoFocus={true}
                                    />
                                </View>
                            ...
                            <View style={common.payModal}>
                                ...
                                <TouchableOpacity style={common.payLi} onPress={this.changePayType.bind(this, 25)}>
                                    <View style={common.alignItemsCenter}>
                                        ...
                                        <Text style={common.payStrong}>银行卡</Text>
    ...
    payNow() {
        if(this.state.pay_type==25 && this.state.cardName=='' || this.state.pay_type==25 && this.state.cardNum==''){
            this.setState({
                cardPay:true,
            })
            return;
